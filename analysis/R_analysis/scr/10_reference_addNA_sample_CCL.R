...
plot_data_overview(MOFAobject)
ggsave("../../out/image/plot_data_overview_ref.pdf",width = 5,height = 5)
...
ggsave("../../out/image/plot_variance_explained_ref.pdf",width = 5,height = 5)
...
pdf("../../out/image/correlate_factors_with_covariates_ref.pdf",width = 5,height = 5)
...
ggsave("../../out/image/plot_weightsF1_Mut_ref.pdf",width = 5,height = 5)
...
ggsave("../../out/image/plot_weightsF1_RNA_ref.pdf",width = 5,height = 5)
...
pdf("../../out/image/plot_enrichment_res.pos_ref.pdf",width = 10,height = 3)
